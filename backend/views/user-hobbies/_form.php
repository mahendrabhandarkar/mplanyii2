...
<div class="user-hobbies-form">
    ...
    <?= $form->field($model, 'fav_music')->textInput(['maxlength' => true]) ?>

    <?= $form->field($model, 'fav_books')->textInput(['maxlength' => true]) ?>

    <?= $form->field($model, 'pre_movies')->textInput(['maxlength' => true]) ?>

    <?= $form->field($model, 'cook_food')->textInput(['maxlength' => true]) ?>
