...
<div class="partner-lifestyle-form">
    ...
    <?= $form->field($model, 'pdiet')->textInput(['maxlength' => true]) ?>

    <?= $form->field($model, 'psmoke')->textInput(['maxlength' => true]) ?>

    <?= $form->field($model, 'pdrink')->textInput(['maxlength' => true]) ?>
